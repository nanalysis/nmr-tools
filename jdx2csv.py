#!/usr/bin/python
#Created by Pablo De Biase (pablodebiase@nanalysis.com)

import sys
if len(sys.argv) < 2:
    print 'Error: Need a filename of JCAMP-DX (.dx/.jdx)'
    print 'This program converts a JCAMP-DX file to a Comma Separated Values file format (.csv)'
    print 'Usage:'
